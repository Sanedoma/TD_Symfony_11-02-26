...
/* post/new.html.twig */
class __TwigTemplate_25c39407bcd86f65a1c634724e0bb7cd extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "<div class=\"example-wrapper\" style=\"margin: 1em auto; max-width: 800px; width: 95%; font: 18px/1.5 sans-serif;\">
    ...
    ";
        ...
        // line 11
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("button_label", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 11, $this->source); })()), "Sauvegarder")) : ("Sauvegarder")), "html", null, true);
        yield "</button>
    ";
        // line 12
    ...
    <a href=\"";
        // line 14
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_post");
...
";
    ...
    {
        return array (  124 => 14,  119 => 12,  115 => 11,  111 => 10,  107 => 9,  102 => 6,  89 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %} {{ parent() }} | Nouveau post{% endblock %}

{% block body %}
<div class=\"example-wrapper\" style=\"margin: 1em auto; max-width: 800px; width: 95%; font: 18px/1.5 sans-serif;\">
    <h1>Créer un nouveau Post</h1>

    {{ form_start(form) }}
        {{ form_widget(form) }}
        <button class=\"btn btn-primary mt-3\">{{ button_label|default('Sauvegarder') }}</button>
    {{ form_end(form) }}

    <a href=\"{{ path('app_post') }}\" class=\"btn btn-secondary mt-3\">Retour à la liste</a>
</div>
{% endblock %}
", "post/new.html.twig", "/home/babybel/Bureau/cours/symfony/ipssi-blog-system/templates/post/new.html.twig");
    }
}
